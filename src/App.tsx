...
function App() {
  let steps:number[] = [0, 2, 0, 3, 3, 2, 1, 1, 0];
    ...
    <div className="App">
      ...
      <Carousel
        ...
        <Paper className="Step-description short-paper">
          ...
          <p>Use your <KeyboardArrowLeftIcon style={{fontSize:'small'}} /> and <KeyboardArrowRightIcon style={{fontSize:'small'}} /> keys to navigate this demonstration.</p>
        </Paper>
        <Paper className="Step-description tall-paper">
          <h1>Triangulation Overview</h1>
            <p>From an unknown location, you see the following landmarks around you.</p>
            ...
            <FadeInOut show={step[0] == 1 && step[1] >= 1}>
              ...
              <p>With your compass, you take bearings* off the landmarks relative to your location.</p>

              <small className='paper-footer'>* 0° refers to north</small>
            </FadeInOut>

            <FadeInOut show={step[0] == 1 && step[1] >= 2} >Match the landmarks to the map, and draw a back bearing from the landmarks.  You pinpoint your location where the lines intersect.</FadeInOut>
        </Paper>
        ...
        <Paper className="Step-description medium-paper">
          ...
          <p>
            <FadeInOut show={step[0] == 3 && step[1] >= 1}>Your target error depends on the bearing error</FadeInOut>
            <FadeInOut show={step[0] == 3 && step[1] >= 2}> as well as distance.</FadeInOut>
            <FadeInOut show={step[0] == 3 && step[1] >= 3}> Walking in a straight line, off by 2° to Mt. Shasta could put you off target by 367.  Easily correctable by visual cues along the way, but when triangulating, the errors compound.</FadeInOut>
          </p>
        </Paper>
        <Paper className="Step-description tall-paper">
          ...
          <p>
            ...
            <FadeInOut show={step[0] == 4 && step[1] >= 1}>  The left bearing now shows an error of 2° in either direction. </FadeInOut>
            <FadeInOut show={step[0] == 4 && step[1] >= 2}>  Your triangulated position could be anywhere along a 3.6km line, or up to 1.8km away from your actual location.</FadeInOut>
          </p>

          
          <FadeInOut show={step[0] == 4 && step[1] >=3}>
            <p>
        ...
        <Paper className="Step-description medium-paper">
          ...
          <p>
            <FadeInOut show={step[0] == 5 && step[1] >= 1}>
              The front bearing is 1° off to the right.
            </FadeInOut>
            <FadeInOut show={step[0] == 5 && step[1] >= 2}>
        ...
        <Paper className="Step-description medium-tall-paper">
          ...
          <FadeInOut className='paper-footer' style={{marginLeft:'3.5em'}} show={step[0] == 7 && step[1] >= 1}>
            <Button onClick={() => { addPoint() }} variant='contained'>Add Point</Button> <Button disabled={additionalPoints == 0} onClick={() => { removePoint() }} variant='outlined'>Remove Point</Button>
          </FadeInOut>
        </Paper>
        <Paper className="Step-description medium-paper">
          <h1>Conclusion</h1>
